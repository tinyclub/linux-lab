...
比如说要处理一些数据，可以用 sed, awk 加 gnuplot ，这个时候 Shell 程序设计就非常重要。关于 Shell，有写过一本开源书籍 [《 Shell 编程范例》][20] 。
...
对了，相关的方面，有写一个序列的 Blog： Linux 下 C 语言程序开发过程的视图，后面整理成了开源书籍，即上面提到的： [《 C 语言编程透视》 ][19] 。
