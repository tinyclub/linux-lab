...
tagline: " 已支持X86_64/PC, ARM/Vexpress-A9, ARM64/Virt 开发板"
draft: false
group: original
...
如果全部同时升级，涉及到一定的工作量，所以我们结合市场使用情况，目前已经优先选择 ARM, X86_64 完成了升级工作。

1. ARM 32, Vexpress-A9
2. ARM 64, Virt
3. X86_64，PC

接下来，我们将逐步完成 MIPS 和 PowerPC 等板子。
...
您可以在微信付费阅读或者直接加入 “Linux 知识星球” 长期和其他各企业一线同行一起学习交流，也可以联系主编微信：lzufalcon 进一步咨询。
