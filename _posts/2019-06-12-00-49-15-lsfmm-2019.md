...
- [自动化测试与 stable tree](https://lwn.net/Articles/789225/)：如何让 Stable tree 更加的 Stable？
...
- [探讨Linux 的 "copy" 性能问题](https://lwn.net/Articles/789623/): 有可能让 Linux 的 copy 操作更快吗？
  ...
  **关键词**：cp, cope_file_range, ACL, xattrs, page cache, io size, fiemap
...
- [讨论如何支持 UFS 新规范的 turbo-write 工作模式](https://lwn.net/Articles/788721/)：准备好应用场景了吗？
...
- [文件系统对 Crash 的容错能力](https://lwn.net/Articles/788938/)：数据真地写到磁盘了吗？
  ...
  **关键词**：fsync, overlayfs, rename, xattrs, fiemap, crashmonkey
  ...
  又在讨论 Application Developers 渴望确保数据真正回写到磁盘的需求，只是讨论到最后也没有结论。另外一篇讨论在 [原子写的一种实现方式](https://lwn.net/Articles/789600/)，反而有一些实质的讨论成果，见上面 May 30 部分的解读。
