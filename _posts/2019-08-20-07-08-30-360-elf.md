...
4. 基础知识筹备
    ...
    * ELF 工具套装介绍
      ...
      * binutils: readelf, objdump, objcopy, strip, sstrip
...
5. ELF 程序的生成
    * 代码编译与编译器优化
      * 编译过程揭秘：预处理、编译、汇编与链接
      * 编译器基础优化：-O2, -Os
      * 编译器进阶优化：gc-sections, branch-probabilities
    * 静态链接和默认链接行为
      * GCC 默认链接参数详解
      * 探索 C 语言真正的入口
      * 默认链接脚本
...
8. 结语：像一个外科手术专家那样
    ...
    * 像敬业的外科医生那样给程序看病 —— 沉着冷静地 Debugging
    * 像专业的外科医生那样熟悉程序组织结构和运行机理 —— ELF 生成、执行和运行
...
1. 访问“阅码场”平台
   ...
   <img src="/images/courses/yomocode-home.jpg" title="阅码场首页" href="http://yomocode.com" width="80%">
...
3. 进入「360° 剖析 Linux ELF」课程页面
   ...
   <img src="/images/courses/360-elf-home.jpg" title="课程首页" href="http://yomocode.com/courses/9" width="80%">

4. 输入专属折扣码

   点击 “输入折扣码，获取额外折扣” 后会看到一个蓝色方框，在框内输入专属折扣码：**W26F**，使用该折扣码享受 10￥ 优惠。

   <img src="/images/courses/360-elf-discount-code.jpg" title="输入折扣码" width="80%">
