...
经过 3 年多的开发与迭代，Linux Lab 已经发布了 [v0.4](http://tinylab.org/linux-lab-v04/) 版，其易用性和功能逐渐强大，非常推荐各位 Linux 内核和嵌入式 Linux 开发者尝试。

下面从列举了十大使用 Linux Lab 的案例。
...
加入我们想学习 x86_64 架构上的 Linux v5.6 内核，可以切到 `x86_64/pc` 这块板子，然后升级到内核 v5.6：
