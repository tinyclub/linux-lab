...
layout: post
author: 'Liu Lichao'
title: "VIRTIO 描述符操作简述"
top: false
draft: false
license: "cc-by-nc-nd-4.0"
permalink: /virtio-introduce/
description: " virtio 描述符操作简述 "
category:
  - 虚拟化
  - virtio
tags:
...
上篇文章说到，为了提高虚拟机的 IO 效率，virtio 标准应运而生，virtio 的核心机制就是通过共享内存在前端驱动与后端实现间进行数据传输，共享内存区域被称作 vring。
...
- 驱动驱动分配 vring
- 驱动更新描述符，如下图所示，一个描述符描述了起始地址为0x8000的长度为2000的设备侧只写的 buffer 区域。
