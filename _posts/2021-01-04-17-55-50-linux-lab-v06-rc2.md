...
layout: post
author: 'Wu Zhangjin'
title: "Linux Lab 发布 v0.6-rc2，新增首块真实硬件开发版"
draft: false
top: true
license: "cc-by-nc-nd-4.0"
permalink: /linux-lab-v06-rc2/
description: "本次发布的 Linux Lab v0.6 rc2，新增首块真实硬件开发版，并增加了命令行自动补全功能。"
category:
  - Linux Lab
  - 开源项目
tags:
...
Linux Lab 于 10 月底发布了 [v0.6-rc1](https://gitee.com/tinylab/linux-lab/tree/v0.6-rc1/) 正式版本，同步发布 Cloud Lab v0.4-rc1。
