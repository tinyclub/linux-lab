...
[上一篇](https://tinylab.org/ebpf-part1) 我们讲述了 eBPF 框架，了解了 BPF 程序的组成，大致分析了 bpf 指令和 map 数据通信，本节来分析下调用流程。
...
libelf 库实现的各个 API 可参考如下 [链接](https://www.zybuluo.com/devilogic/note/139554) 以及我们专门为此准备的 [libelf 开源库用法详解](https://tinylab.org/libelf)。
