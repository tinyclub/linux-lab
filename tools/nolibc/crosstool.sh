...
VERSION=13.2.0
MIRROR=https://mirrors.ustc.edu.cn/kernel.org/tools/crosstool/
HOST=`uname -m`
TOOLCHAINS="aarch64-linux arm-linux-gnueabi loongarch64-linux mips64-linux powerpc64-linux riscv64-linux s390-linux x86_64-linux"
